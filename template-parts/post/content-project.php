...
$count   = get_option('mangapostproject');
$myposts = array(
    'showposts'              => $count,
    'post_type'              => 'komik',
	    ...
	    <div class="utao">
	        <div class="uta">
	            ...
	            <div class="luf">
	                ...
	                <ul class="<?php echo strip_tags(get_the_term_list(get_the_ID(), 'type')); ?>">
	                    <?php
...
// Loop through posts
    ...
    foreach ($wpex_query->posts as $post): setup_postdata($post);?>
		                    ...
		                    <li><a href="<?php the_permalink();?>">Ch.
